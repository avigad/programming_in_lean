...
\lstset{language=lean,breakatwhitespace,frame=lines}
...
% \usepackage[dvipsnames,table]{xcolor}
\hypersetup{
    pdftitle={Programming in Lean},
    pdfauthor={Jeremy Avigad and Leonardo de Moura},
    colorlinks,
    linkcolor=Sepia,
...
\renewcommand{\maketitle}{
  ...
  \par
  \noindent
  Copyright (c) 2016, Jeremy Avigad, Leonardo de Moura, and Jared Roesch. All rights reserved.
