...
html_theme_options = {
    ...
    'code_bg': 'white',
    'extra_nav_links': {'PDF version':'programming_in_lean.pdf',
...
htmlhelp_basename = 'programming_in_lean'
...
man_pages = [
    (master_doc, 'programming_in_lean', u'Programming in Lean',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'programming_in_lean', u'Programming in Lean',
     author, 'programming_in_lean', 'A tutorial',
     'Miscellaneous'),
]
